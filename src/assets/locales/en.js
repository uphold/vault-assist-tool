...
export const en = {
  translation: {
    ...
    "access.fields.address.errors.invalid": "Please enter the correct {{currency}} Vault address.",
    ...
    "actions.end.session": "End session and protect my keys",
    ...
    "transaction.failure.description": "This could be caused by temporary on the blockchain. Please try again later. If you need help, please contact Customer Support.",
