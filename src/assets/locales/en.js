...
export const en = {
  translation: {
    ...
    "access.fields.address.details.bullet1": "In the Uphold app when accessing the Vault page for the specific asset",
    "access.fields.address.details.bullet2": "In the email you received when you created your Vault for this crypto asset",
    "access.fields.address.details.description": "Each crypto asset in your Vault has its own wallet address. You can find the address in two locations:",
    "access.fields.address.details.header": "XRP Vault address",
    "access.fields.address.errors.invalid": "Please enter the correct Vault address.",
    "access.fields.address.errors.invalid.xrp": "Enter the correct XRP Vault address.",
    ...
    "landing.description": "Using your two private keys, safely withdraw all your Vault assets (minus the network costs) in the unlikely event Uphold ceases to exist.",
    ...
    "messages.error.account.not.vault": "Account is not a vault",
    ...
    "withdraw.xrp.confirm.description": "To access and withdraw your funds, you need to enter your two private keys.",
    "withdraw.xrp.confirm.fields.backup.key.details.description": "The Backup key is the 12-word phrase, serves as your private backup key. When you created your Vault, a Backup key was generated for you, and it was strongly recommended that you securely store it in a location under your contro. Uphold doesn't have access to this key.",
    "withdraw.xrp.confirm.fields.backup.key.details.header": "Backup key",
    "withdraw.xrp.confirm.fields.backup.key.errors.invalid": "Please enter the correct keys for this Vault.",
    ...
    "withdraw.xrp.confirm.fields.keys.error.invalid": "Please enter the correct keys for this Vault.",
    "withdraw.xrp.confirm.fields.vault.key.details.description": "The Vault key is your everyday tool for accessing the Vault. It's stored in a text file on both your device and in the Cloud, created at the moment you set up your Vault.",
    "withdraw.xrp.confirm.fields.vault.key.details.header": "Vault Key",
    "withdraw.xrp.confirm.fields.vault.key.errors.invalid": "Please enter the correct keys for this Vault.",
    ...
    "withdraw.xrp.destination.fields.destination.tag.errors.invalid": "Please enter the correct 10-digit tag (0-9).",
