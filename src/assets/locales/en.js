...
export const en = {
  translation: {
    ...
    "access.details.title2": "Network Vault",
    ...
    "withdraw.hbar.destination.fields.address.errors.invalid.hbar": "Please enter the correct HBAR address.",
    "withdraw.hbar.destination.fields.address.errors.required": "The address is required",
    "withdraw.hbar.destination.fields.address.label": "Destination HBAR address",
    "withdraw.hbar.destination.fields.address.placeholder": "e.g. 0.0.98765...",
    "withdraw.hbar.destination.fields.destination.memo.errors.invalid": "The memo field has a maximum length of 100 characters",
    "withdraw.hbar.destination.fields.destination.memo.label": "Destination Memo",
    "withdraw.hbar.destination.fields.destination.memo.placeholder": "e.g. 0123456789",
    "withdraw.hbar.destination.label.network.costs": "Network costs",
    "withdraw.hbar.destination.label.withdraw.amount": "Amount to withdraw",
    "withdraw.hbar.destination.warning": "Make sure to enter the correct HBAR address on the Hedera network.",
    "withdraw.hbar.navigation.title": "Withdraw HBAR",
