...
export const en = {
  translation: {
    ...
    "withdraw.xrp.conditions.account.deletion.label": "Account Deletion:",
    "withdraw.xrp.conditions.account.deletion.text": "Closing the XRP Vault deletes the associated XRP account. You get {{baseReserve}}, less the fee of {{ownerReserve}}",
    "withdraw.xrp.conditions.funds.label": "Funds Retrieval:",
    "withdraw.xrp.conditions.funds.text": "The XRP held in the Vault, {{remainingBalance}} is transferred to your designated XRP address.",
